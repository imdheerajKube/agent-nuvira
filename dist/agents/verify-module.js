 ...
 */
export class DefaultVerifyModule {
    eventBus;
    ...
    async verify(params) {
        ...
        const blockingCount = checks.filter((c) => !c.passed && c.severity === 'blocking').length;
    ...
    runTestCheck(testResults, strictness) {
    ...
    runOutputCheck(runOutput, strictness) {
