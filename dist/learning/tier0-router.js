 ...
 */
export function detectTier0Intent(goal, artifacts) {
...
function describeIntent(type, matched) {
    switch (type) {
        case 'remove-console':
 ...
 */
export function symbolInStringOrComment(code, name) {
...
export function applyTier0Transform(intent, artifact) {
    switch (intent.type) {
        case 'remove-console': {
        ...
        case 'rename-symbol': {
            ...
            if (symbolInStringOrComment(artifact.content, oldName))
                return null;
            const result = renameSymbol(artifact.content, artifact.path, { oldName, newName });
            if (!result.success || result.code === null || result.code === artifact.content)
                return null;
 ...
 */
export function tryTier0Route(goal, artifacts) {
...
//# sourceMappingURL=tier0-router.js.map