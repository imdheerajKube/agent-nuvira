...
export declare const MAX_SKILLS = 50;
/** Min trajectories needed for compilation */
export declare const MIN_TRAJECTORIES_FOR_COMPILATION = 2;
/** Max trajectories to use for a single compilation pass */
export declare const MAX_TRAJECTORIES_FOR_COMPILATION = 5;
/** Min score for a trajectory to be considered for compilation */
export declare const MIN_TRAJECTORY_SCORE_FOR_COMPILATION = 0.65;
/** How many successful runs between auto-compilation checks */
export declare const SKILL_COMPILATION_INTERVAL = 5;
/** Skills storage directory version */
export declare const SKILL_STORE_VERSION = 1;
