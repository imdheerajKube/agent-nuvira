...
export class PhaseCommand extends BaseCommand {
    create() {
        ...
        command
            ...
            .action(async (name, goals, options) => {
    ...
    // ─── Create ──────────────────────────────────────────────────────────────
    async createScope(name, goals, options) {
    ...
    // ─── Execute ────────────────────────────────────────────────────────────
    async executeScope(name, options) {
        const engine = new PhaseExecutionEngine();
        ...
        const executeFn = async (goal, _phaseId, _phaseDescription) => {
    ...
    // ─── Resume ────────────────────────────────────────────────────────────
    async resumeScope(name, options) {
        const engine = new PhaseExecutionEngine();
        const scope = engine.loadScope(name);
        if (!scope) {
            logger.error(`No phase scope found: "${name}"`);
