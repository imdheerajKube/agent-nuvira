...
import { getReview, listReviews, addReviewComment, mergeReview, rejectReview, createReview, } from '../team/review.js';
export class TeamCommand extends BaseCommand {
    create() {
        ...
        reviewCmd
            ...
            .action(async (title, goal, options) => {
    ...
    // ── review ───────────────────────────────────────────────────────────────
    async handleReviewList(options) {
