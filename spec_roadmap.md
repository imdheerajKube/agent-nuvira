...
Agent-baba-d is a solid single-agent CLI with 5 built-in providers (expandable to 17+ via env vars and plugin system). Core built-in: local/Ollama, Nim, Gemini, OpenRouter, Groq. It has:
┌───────────────────────────────┬────────────────┐
│ Capability                    │ Status         │
├───────────────────────────────┼────────────────┤
...
- Single-agent CLI with 5 built-in providers (expandable to 17+)
