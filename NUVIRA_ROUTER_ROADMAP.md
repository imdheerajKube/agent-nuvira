...
|---|---|---|---|
| P0 | M0.1 Baseline lock | [#1](https://github.com/imdheerajKube/agent-nuvira/issues/1) | ⬜ | — |
| P0 | M0.2 Shared failover runner | [#1](https://github.com/imdheerajKube/agent-nuvira/issues/1) | ⬜ | — |
