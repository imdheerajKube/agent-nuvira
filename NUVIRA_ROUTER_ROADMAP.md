...
| P2 | M2.2 Wire-token cost inputs | [#3](https://github.com/imdheerajKube/agent-nuvira/issues/3) | ✅ | PENDING |
| P2 | M2.3 Multi-account rotation | [#3](https://github.com/imdheerajKube/agent-nuvira/issues/3) | ⬜ | — |
| P2 | M2.4 Governance constraints | [#3](https://github.com/imdheerajKube/agent-nuvira/issues/3) | ⬜ | — |
| P2 | M2.5 Context-length preflight | [#3](https://github.com/imdheerajKube/agent-nuvira/issues/3) | ⬜ | — |
